...
```{r krissyPic, out.width='200px', echo=FALSE}
knitr::include_graphics('KrissyHopkins.jpg')
```
...
```{r josephPic, out.width='200px', echo=FALSE}
knitr::include_graphics('Joseph_Delesantro.png')
```
...
```{r samPic, out.width='200px', echo=FALSE}
knitr::include_graphics('SamZipper.png')
```
