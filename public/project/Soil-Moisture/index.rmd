...
## SMAP Products
The NASA Distributed Archive Center at the National Snow and Ice Data Center processes and distributes a wide range of products derived from the SMAP satellite. [You can dig into all of them here](https://nsidc.org/data/smap/smap-data.html), however, the two we will be focused on are the SMAP/Sentinel-1  L2 Radiometer/Radar 3km product and the SMAP L4 Global 3-hourly 9 km EASE-Grid Surface and Root Zone Soil Moisture Analysis