...
<audio controls>
  <source src="/slides/intro_geographic_information/Day07/audio/d07s02.mp3" type="audio/mpeg">
...
<audio controls>
  <source src="/slides/intro_geographic_information/Day07/audio/d07s03.mp3" type="audio/mpeg">
  <p>Your browser doesn't support HTML5 audio.</p>
</audio>
...
<audio controls>
  <source src="/slides/intro_geographic_information/Day07/audio/d07s04.mp3" type="audio/mpeg">
  <p>Your browser doesn't support HTML5 audio.</p>
</audio>

???

There are many pros and cons to the use of raster data. A lot of the historical issues however are being overcome by the increases in computational power and the price of storage of large amounts of data. It used to be that a gigabyte was a lot of data to store on a computer, now we can get a laptop with a terabyte for a few hundred dollars. UNC has two super computers that are accesible to researchers that provide huge amoiunts of storage and computing power so theyse issues are starting to fade away. Although the more power we have the more we try to do so it is somewhat of a balancing act. The use of rasters vs vectors really should come down to the purpose of the data use and what factors into your resolution needs. 
...
[LINK](https://unc.zoom.us/rec/share/ov5xEYr81WVIEo2Q917if5IHP4LFT6a81XUe_vVcy0jz-nZuM9y-qPbv4XFtoyVy?startTime=1593526405000)
]
]

<audio controls>
  <source src="/slides/intro_geographic_information/Day07/audio/d07s05.mp3" type="audio/mpeg">
  <p>Your browser doesn't support HTML5 audio.</p>
</audio>

???

For the rest of this lecture, I want to walk you through obtaining some data and talking about how to represent rasters in ArcGIS Pro. Click the link to go to a recorded zoom lecture where I will talk more about this. You are welcome to follow along step by step but it is not required.