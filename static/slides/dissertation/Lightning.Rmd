...
Hello to all of you hopefully future colleagues. My name is Andrew Murray, I'm a 3rd year PhD student here in the department and I'm excited share just a little bit of my research with you today. As you can see from the title here, we're talking about about the effects of extreme precipitation on connectivity and how we measure it using remote sensing. 
---
exclude: true
...
The DRASTIC Index was a big project completed by the National groundwater well association and EPA in 1983. The point of it was to use geophysical data to estimate the risk to groundwater. It accounts for the height of the water table, the rate of recharge of groundwater, the composition of the aquifer, the soil composition, topography, the composition of the vadose zone and conductivity, which can be thought of us the speed with which water can move throught the soil. This index has been widely used but it misses quite a few important components. For one thing, it assumes conditions are static. What I mean by this is that it doesn't account for the current state of the landscape, such as how much vegetation there is or how saturated the soil is. When researchers calculate a DRASTIC index, they do it once, and there is no temporal component to it. My goal is to change this by adding in soil moisture and vegetation compnents measured from satellites. 
...
???
Let's take a look at how soil moisture actually does change during an extreme rainfall event, in this case, Hurricane Florence. The Carolinas were saturated prior to landfall of Florence. Note how long drying takes to occur and the variance across the state
---
...
You may not have noticed just by looking at the animation, but take a look at these side by side maps pf wetting and drying. On the left side, we can see wetting, which is the increase in soil moisture between the day before landfall of Hurricane Florence and the peak soil moisture measured after landfall. The map on the right shows us drying, which is the change in soil moisture between the peak and the lowest measured soil moisture within three weeks after Hurricane Florence made landfall. We can see that wetting closely mirrors precipitation, but drying is much more spatially complex. Deconstructing why and how this is happening is the crux of my dissertation research.
...
As much as I would like to drone on and on about all of this for hours, let's bring it back to the main points of my research. 
**FORWARD**
