...
So how do we figure this out. We know a lot about the physical environment and by combining that data we can build an index for physical vulnerability. The DRASTIC Index was one such project completed by the National groundwater well association and EPA in 1983. The point of it was to use geophysical data to estimate the risk to groundwater. It accounts for the height of the water table, the rate of recharge of groundwater, the composition of the aquifer, the soil composition, topography, the composition of the vadose zone and conductivity, which can be thought of us the speed with which water can move throught the soil. This index has been widely used but it misses quite a few important components. For one thing, it assumes conditions are static. What I mean by this is that it doesn't account for the current state of the landscape, such as how much vegetation there is or how saturated the soil is. When researchers calculate a DRASTIC index, they do it once, and there is no temporal component to it. My goal is to change this by adding in soil moisture and vegetation compnents measured from satellites. We've come a long way, computationally since 1983 and we have much more detailed observations of the earth which means it's time for an overhaul.
