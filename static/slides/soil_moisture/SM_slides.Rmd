...
## <span style="color:black">Hurricane Florence, 2018 (Credit: NASA)</span> {data-background="C:/Users/ARMur/OneDrive - University of North Carolina at Chapel Hill/website_rebuild/Andrews_Website/static/img/hurricane_space.jpg"}
...
```{r wellsNcanes, echo=FALSE, fig.height= 5.9}
myimg <- load.image(here("static/img/wells_hurricanes.png"))
