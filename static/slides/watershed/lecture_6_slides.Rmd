...
Recall: $z = \frac{a - \overline{x}}{S_{x}}$
...
- We give $G(z)$ (The probability of exceedance): which is 33% / .33 (every three years). Since $G(z)+F(z)=1$, $1-.33 = .67$ We work backwards to get the $z$-value from the table: 0.67, $z=.404$ which we then sub into the equation to determine $a$
